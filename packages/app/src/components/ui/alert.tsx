...
const alertVariants = cva('flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)', {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      appearance: 'solid',
      className:
        'bg-[var(--color-info,var(--color-blue-600))] text-[var(--color-info-foreground,var(--color-white))]',
    },
    {
      variant: 'warning',
      appearance: 'solid',
    ...
    },
    {
      ...
      appearance: 'outline',
      className:
        'border border-border bg-background text-[var(--color-info,var(--color-blue-600))] [&_[data-slot=alert-close]]:text-foreground',
    },
    {
      variant: 'warning',
      appearance: 'outline',
    ...
    },
    {
      ...
      appearance: 'light',
      className:
        'bg-[var(--color-info-soft,var(--color-blue-50))] border border-[var(--color-info-alpha,var(--color-blue-100))] text-foreground [&_[data-slot=alert-icon]]:text-[var(--color-info-foreground,var(--color-blue-600))] dark:bg-[var(--color-info-soft,var(--color-blue-950))] dark:border-[var(--color-info-alpha,var(--color-blue-900))]',
    },
    {
      variant: 'warning',
      appearance: 'light',
    ...
    },
    {
      variant: 'mono',
      icon: 'info',
      className: '[&_[data-slot=alert-icon]]:text-[var(--color-info-foreground,var(--color-blue-600))]',
    },
  ],
  defaultVariants: {
    variant: 'secondary',
